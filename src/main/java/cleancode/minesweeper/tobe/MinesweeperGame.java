...
public class MinesweeperGame {
    ...
    static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                actOnCell(cellInputCol, cellInputRow, userActionInput);
    ...
    private static void actOnCell(char cellInputCol, char cellInputRow, String userActionInput) {
    ...
    private static void showBoard() {
        ...
        for (int row = 0; row < BOARD_ROW_SIZE; row++) {
            ...
            for (int j = 0; j < BOARD_COL_SIZE; j++) {
                System.out.print(BOARD[row][j].getSign() + " ");
            }
            System.out.println();
        }
    }
    ...
    private static void initializeGame() {
        ...
        for (int row = 0; row < BOARD_ROW_SIZE; row++) {
            for (int col = 0; col < BOARD_COL_SIZE; col++) {
                ...
                BOARD[row][col].updateNearbyLandMineCount(countNearbyLandMines(row, col));
            }
        }
    }
